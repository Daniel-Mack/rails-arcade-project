...
player1 = Player.create!(name: "Kynsin", password: "password", skill_level: "high", age: 18)
player2 = Player.create!(name: "Xeneth", password: "words", skill_level: "medium", age: 34)
player3 = Player.create!(name: "Kerune", password: "random", skill_level: "low", age: 21)
